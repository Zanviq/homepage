...
def translate_texts(texts: list[str], source: str = "ko", target: str = "en") -> list[str]:
    ...
    prompt = (
        ...
        f"text inside code fences or URLs. Keep the paragraph structure of each "
        f"element: do not add or remove blank lines, so paragraphs stay paired "
        f"with the source. Return a JSON array of translated "
